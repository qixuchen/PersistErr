...
void write_results_to_file(const int alg_id, const vector<point_t *> &point_return, const int best_idx){
    ofstream ofs;
    ofs.open("../../log_user_study/user_study_semi_fix_ques_num/" + file_names[alg_id], ofstream::out);
...
void record_ques_history(const int alg_id){
    ofstream ofs;
    ofs.open("../../log_user_study/user_study_semi_fix_ques_num_history/" + to_string(alg_id+1) + ".txt", ofstream::out);
...
void write_cf_info(const int alg_id, const vector<int> &cr_belong){
    ofstream ofs;
    ofs.open(string("../../log_user_study/user_study_semi_fix_ques_num/") + "conf_reg" + file_names[alg_id], ofstream::out);
...
void write_summary(int best_idx){
    ofstream ofs;
    ofs.open("../../log_user_study/user_study_semi_fix_ques_num/summary.txt", ofstream::out);
