...
int Preference_Learning(std::vector<point_t *> original_set, point_set_t *P0, int w, int alg_id, int max_round)
{
    reset_stats();
    start_timer();
    int M, round = 0, maxQcount = max_round, testCount = 0, correctCount = 0;;
